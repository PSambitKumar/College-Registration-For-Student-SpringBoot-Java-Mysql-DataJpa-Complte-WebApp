...
public class CollegeController {
	...
	@GetMapping(value = "/deleteCollegeDepartment/{id}")
	public String deleteCollegeDepartment(@PathVariable(value = "id")int id){
		System.out.println("Inside Delete College Department Method------------->>");
		System.out.println("College Department Id : " + id);
		collegeDepartmentService.deleteCollegeDepartmentByCollegeDepartmentId(id);
		return "redirect:/addCollege";
	}

	@GetMapping(value = "/deleteCollege/{id}")
	public String deleteCollege(@PathVariable(value = "id")int id){
		System.out.println("Inside Delete College Method------------->>");
		System.out.println("College Id : " + id);
		collegeService.deleteCollegeByCollegeId(id);
		return "redirect:/addCollege";
	}
